/*
 * Modified version of jsPsychHtmlButtonResponse plugin to end the trial when the audio is finished playing
 */

var jsPsychHtmlEndTrialOnAudioFinish = (function (jspsych) {
  'use strict';
